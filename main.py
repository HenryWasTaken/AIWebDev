...
st.markdown("<p style='color:white;'>Developed under Abingdon AI Web Development Club, <a href='mailto:henry.sun@abingdon.org.uk' style='color:white;'>Henry Sun</a></p>", unsafe_allow_html=True)
